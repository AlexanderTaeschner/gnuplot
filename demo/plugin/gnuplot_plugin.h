...
struct array_header {
        int64_t size;                   /* This array is indexed from 1 to size */
...
typedef struct value {
	...
	struct array_header array_header;  /* substructure of value_array[0] */
    } v;
} t_value;
...
/* This is the type for a generic external function called by gnuplot.
 * It is passed the number of parameters, an array holding those
 * parameters, and an opaque token generated by the initialization
...
DLLEXPORT void gnuplot_fini(exfn_t,  void *);
