...
typedef enum PLOT_STYLE {
    ...
    MARKS        = 43*PLOT_STYLE_BITS + PLOT_STYLE_HAS_LINE + PLOT_STYLE_HAS_POINT + PLOT_STYLE_HAS_FILL,
    LINESMARKS   = 44*PLOT_STYLE_BITS + PLOT_STYLE_HAS_LINE + PLOT_STYLE_HAS_POINT + PLOT_STYLE_HAS_FILL,
    PLOT_STYLE_NONE = -1
} PLOT_STYLE;
