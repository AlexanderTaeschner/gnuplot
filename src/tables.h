...
enum set_id {
    ...
    S_COLOR, S_COLORMAP, S_COLORSEQUENCE, S_CONTOURFILL, S_CORNERPOLES,
    S_DASHTYPE, S_DATA, S_DATAFILE, S_DECIMALSIGN, S_DGRID3D, S_DUMMY, S_ENCODING,
    S_FIT, S_FONTPATH, S_FORMAT, S_FUNCTIONS, S_GRID, S_HELP,
    S_HIDDEN3D, S_HISTORY, S_HISTORYSIZE,
    S_I_SYMBOL, S_ISOSAMPLES, S_ISOTROPIC, S_PIXMAP,
    S_JITTER, S_KEY, S_LABEL, S_LINK, S_NONLINEAR,
    S_LINESTYLE, S_LINETYPE, S_LOADPATH, S_LOCALE, S_LOGSCALE, S_MACROS,
    S_MAPPING, S_MARK, S_MARKS, S_MARGIN, S_LMARGIN, S_RMARGIN, S_TMARGIN, S_BMARGIN,
    S_MISSING, S_MICRO, S_MINUS_SIGN, S_MOUSE,
...
enum set_key_id {
    ...
    S_KEY_KEYWIDTH, S_KEY_COLS, S_KEY_MAXCOLS, S_KEY_MAXROWS,
...
enum set_colorbox_id {
    ...
    S_COLORBOX_DEFAULT, S_COLORBOX_USER, S_COLORBOX_BOTTOM,
...
enum set_palette_id {
    ...
    S_PALETTE_MODEL, S_PALETTE_GAMMA, S_PALETTE_CUBEHELIX, S_PALETTE_VIRIDIS,
};
...
enum set_pm3d_id {
    ...
    S_PM3D_WHICH_CORNER,
    S_PM3D_LIGHTING_MODEL, S_PM3D_NOLIGHTING_MODEL, S_PM3D_SPOTLIGHT
};
...
enum show_style_id {
    ...
    SHOW_STYLE_TEXTBOX, SHOW_STYLE_WATCHPOINT
};
